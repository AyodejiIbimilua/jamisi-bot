...
- Get me news from [BBC](query)
- I want news from [Vanguard](query)
- What is [The Nation](query) saying?
- What is happening in [Nigeria](query)
- Latest update in [China](query)
- Latest update in [England](query)
- What is happening in the [business world](query)
- Tell me about [cryto](query) in [Nigeria](query)
- Tell me about [ethereum](query) in [USA](query)
- Gist me about [Barrack Obama](query)
- Give me some [entertainment news](query) in [Nigeria](query)
- Give me [business news](query)
- Give me [sports news](query)
- news in [tech](query)
- news in [science world](query)
- news in the [health sector](query)
- get me some news in [finance](query)
- I want gist on [education](query) in [Nigeria](query)
...
- I need [sports](query) news in [China](query)
- What top stories is the [NY Times](query) running right now?
- What news articles were published about the next [iphone](query) today?
- Can you please give me some [technology news](query)?
- I want some [business news](query)
- Give me news about money [heist](query)
- Any information about [ISIS](query)
- Whats going on in the [white house](query)
- I need some news in the [entertainment industry](query) of [Nigeria](query)
